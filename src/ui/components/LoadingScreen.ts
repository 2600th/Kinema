...
export class LoadingScreen implements Disposable {
  ...
  constructor() {
    ...
    const glowConfigs = [
      { width: '38%', height: '26%', top: '4%', left: '-10%', background: 'radial-gradient(circle at 48% 50%, rgba(98,230,255,0.28), rgba(98,230,255,0.1) 34%, transparent 72%)', animation: 'loadingGlowDrift 24s ease-in-out infinite alternate' },
      { width: '34%', height: '24%', top: '-4%', right: '-8%', background: 'radial-gradient(circle at 50% 50%, rgba(255,121,186,0.24), rgba(255,121,186,0.08) 34%, transparent 72%)', animation: 'loadingGlowDrift 28s ease-in-out infinite alternate-reverse' },
      { width: '42%', height: '28%', bottom: '-10%', left: '22%', background: 'radial-gradient(circle at 50% 50%, rgba(123,108,255,0.2), rgba(123,108,255,0.08) 34%, transparent 74%)', animation: 'loadingGlowDrift 30s ease-in-out infinite alternate' },
    ];
    ...
    Object.assign(pane.style, {
      ...
      borderRadius: '54px',
      overflow: 'hidden',
      background: 'linear-gradient(130deg, rgba(255,255,255,0.11), rgba(255,255,255,0.025) 28%, rgba(255,255,255,0.06) 56%, rgba(255,255,255,0.025) 76%), linear-gradient(180deg, rgba(15, 23, 44, 0.52), rgba(8, 12, 24, 0.3))',
      border: '1px solid rgba(255,255,255,0.08)',
      boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.18), inset 0 -1px 0 rgba(98,230,255,0.08), 0 55px 140px rgba(0,0,0,0.34)',
    ...
    Object.assign(paneSheen.style, {
      ...
      background: 'linear-gradient(118deg, rgba(255,255,255,0.08), transparent 18%, transparent 58%, rgba(98,230,255,0.06) 70%, transparent 84%), linear-gradient(180deg, rgba(255,255,255,0.035), transparent 28%)',
      mixBlendMode: 'screen',
      opacity: '0.88',
    });
    ...
    Object.assign(field.style, {
      position: 'absolute',
      inset: '-3%',
      background: 'repeating-radial-gradient(circle at 24% 40%, rgba(98,230,255,0.08) 0 2px, transparent 2px 18px), repeating-radial-gradient(circle at 76% 24%, rgba(255,121,186,0.06) 0 2px, transparent 2px 20px), repeating-radial-gradient(circle at 58% 76%, rgba(123,108,255,0.07) 0 2px, transparent 2px 22px)',
      opacity: '0.22',
