...
2. Create `EffectComposer` with `RenderPass` and one reusable raw output-grade pass for tone mapping, output conversion, LUT, and vignette; apply capped 4x samples to both internal render targets and the measured 0.75 compatibility scale.
